...
tags:
  ...
  - multivariate
  - cstu40
description: "สรุปสูตรสำคัญและคำอธิบายกระชับ รายวิชา ST329 สถิติสำหรับวิทยาการข้อมูล ครอบคลุมบทที่ 1 ถึง 5 จากเอกสารประกอบการสอน"
created: 2026-08-21
updated: 2026-09-05
parent: "ST329"
---

# ST329 — สรุปสูตรสถิติและความน่าจะเป็น
...
- **การเรียงสับเปลี่ยนสิ่งของที่มีของซ้ำกัน:**
...
- **ทฤษฎีความน่าจะเป็นรวม:**
  $$P(A) = \sum_{i=1}^n P(B_i) P(A \mid B_i)$$
  *คำอธิบาย:* เมื่อ $B_1, \dots, B_n$ เป็นผลแบ่งกั้น ของปริภูมิตัวอย่าง $S$ ที่ไม่เกิดร่วมกันและรวมกันได้ $S$
- **ทฤษฎีบทของเบยส์ (Bayes' Theorem):**
  $$P(B_k \mid A) = \frac{P(B_k) P(A \mid B_k)}{\sum_{i=1}^n P(B_i) P(A \mid B_i)}$$
  *คำอธิบาย:* คำนวณความน่าจะเป็นแบบย้อนกลับ ของสาเหตุ $B_k$ เมื่อทราบผลลัพธ์ $A$

---

## บทที่ 2: ตัวแปรสุ่ม ค่าคาดหมาย และความแปรปรวน

### 1. ฟังก์ชันความน่าจะเป็น (PMF, PDF, CDF)
- **ฟังก์ชันมวลความน่าจะเป็น — ตัวแปรสุ่มไม่ต่อเนื่อง:**
  $$f(x) = P(X = x), \quad f(x) \ge 0, \quad \sum_{x \in R_X} f(x) = 1$$
- **ฟังก์ชันความหนาแน่นความน่าจะเป็น — ตัวแปรสุ่มต่อเนื่อง:**
...
## บทที่ 3: ตัวแปรสุ่มไม่ต่อเนื่องบางชนิด

| การแจกแจง | สัญลักษณ์ | ฟังก์ชันมวลความน่าจะเป็น $f(x) = P(X = x)$ | ค่าคาดหมาย $E(X)$ | ความแปรปรวน $\operatorname{Var}(X)$ | คำอธิบายสั้นและเงื่อนไขการใช้ |
| :--- | :---: | :--- | :---: | :---: | :--- |
...
## บทที่ 4: ตัวแปรสุ่มต่อเนื่องบางชนิด

| การแจกแจง                      |               สัญลักษณ์               | ฟังก์ชันความหนาแน่นความน่าจะเป็น $f(x)$                                                             |  ค่าคาดหมาย $E(X)$  | ความแปรปรวน $\operatorname{Var}(X)$ | คำอธิบายสั้นและเงื่อนไขการใช้                                                                                                                                                             |
| :-------------------------------------------- | :-----------------------------------: | :-------------------------------------------------------------------------------------------------- | :-----------------: | :---------------------------------: | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
| **เลขชี้กำลัง**<br>*(Exponential)*            |     $\operatorname{Exp}(\lambda)$     | $f(x) = \lambda e^{-\lambda x}, \quad x \ge 0$                                                      | $\frac{1}{\lambda}$ |        $\frac{1}{\lambda^2}$        | ระยะเวลาระหว่างเหตุการณ์ปัวซงสองครั้งติดกัน มีสมบัติไร้ความทรงจำ: $P(X > s+t \mid X > s) = P(X > t)$                                                                |
...
- **ความเป็นอิสระต่อกันของตัวแปรสุ่ม:**
